...
namespace Test
{
    public partial class F0513 : Form
    {
        ...
        public void OnCreateDevice(object sender, EventArgs e)
        {
            ...
            mtrl.Specular = Color.White;
            mtrl.SpecularSharpness = 10f;
        }
        ...
        private void SetupLights()
        {
            ...
            device.Lights[0].Direction = new Vector3((float)Math.Cos(Environment.TickCount / 250f), 1, (float)Math.Sin(Environment.TickCount / 250f));
