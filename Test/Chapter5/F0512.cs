...
namespace Test
{
    public partial class F0512 : Form
    {
        ...
        private void onCreateVertexBuffer(object sender, EventArgs e)
        {
            ...
            verts[0].Position = new Microsoft.DirectX.Vector3(-0.2f, -2, -.2f);
            verts[0].Normal = new Microsoft.DirectX.Vector3(0, 1, 0);
            verts[1].Position = new Microsoft.DirectX.Vector3(-.2f, -2, .2f);
            verts[1].Normal = new Microsoft.DirectX.Vector3(0, 1, 0);
            verts[2].Position = new Microsoft.DirectX.Vector3(.2f, -2, .2f);
            verts[2].Normal = new Microsoft.DirectX.Vector3(0, 1, 0);
            verts[3].Position = new Microsoft.DirectX.Vector3(-.2f, -2, -.2f);
            verts[3].Normal = new Microsoft.DirectX.Vector3(0, 1, 0);
            verts[4].Position = new Microsoft.DirectX.Vector3(.2f, -2, .2f);
            verts[4].Normal = new Microsoft.DirectX.Vector3(0, 1, 0);
            verts[5].Position = new Microsoft.DirectX.Vector3(.2f, -2, -.2f);
        ...
        private void SetupLights()
        {
            ...
            device.Lights[0].Position = new Vector3(0, 4, -6);
            device.Lights[0].Direction = new Vector3(0, -4, 4);
